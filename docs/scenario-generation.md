...
CharacterProfile を反映した prompt building、OpenAI scenario generation、Episode generation、weather/headline integration、persistence、public API、TTS/audio generation は未実装です。
